...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        help="path to the target audio voice",
    )
    ...
    if args.voice_conversion is not None:
        ...
        enc_model_fpath = Path(
            "checkpts_vc/spk_encoder/pretrained.pt"
    ...
    with torch.no_grad():
        for i, text in enumerate(texts):
            ...
            if args.voice_conversion is not None:
                ...
                mel_encoded, mel_ = generator_vc.forward(
                    mel_source,
                    mel_source_lengths,
                    mel_target,
                    mel_target_lengths,
